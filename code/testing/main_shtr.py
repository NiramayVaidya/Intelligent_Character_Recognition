...
def main():
    ...
    # infer text on test image
        ...
        check_location = '../../testing/generated_words/para_6_with_gaps/'
        with open('../../testing/recognized_text.txt', 'w') as f:
            with open('../../testing/original_data_text_files/para_6_with_gaps.txt') as orig:
